...
export const VERSIONS = [
  { key: "phase-1", label: "Phase 1", desc: "Survey creation flow", port: 5180, path: "phase-1", toolbarKey: "id-backstage" },
  { key: "phase-2", label: "Phase 2", desc: "Survey-scoped customization", port: 5181, path: "phase-2", toolbarKey: "id-backstage" },
  { key: "phase-3", label: "Phase 3", desc: "Builds on phase 2", port: 5182, path: "phase-3", toolbarKey: "id-backstage" },
];
